...
ifneq ($(filter coverage%,$(MAKECMDGOALS)),)
	...
	DEPS_test/sharness += cmd/luanet/luanet-test-cover $(d)/coverage_deps $(d)/ipfs
endif

export IPFS_COVER_DIR:= $(realpath $(d))/sharnesscover/

$(d)/sharness_tests.coverprofile: export TEST_NO_PLUGIN=1
$(d)/sharness_tests.coverprofile: $(d)/ipfs cmd/luanet/luanet-test-cover $(d)/coverage_deps test_sharness_short
